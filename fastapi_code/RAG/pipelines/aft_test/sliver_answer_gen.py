...
TEST_FILE = (
    "RAG/datasets/brain/ZZ/test_data/test_dataset1.json"   #最开始的所有query
)

FINAL_CHUNK_FILE =("RAG/datasets/brain/ZZ/final_all/final_chunk.json")  #最开始的所有文段

SAVE_LLM_RESULT = ("RAG/datasets/brain/ZZ/test_data/test_result_final1.json")   #LLM判定后的答案
...
async def run_test():
    ...
    # 保存最终 LLM 结果
    save_test_data(llm_pred_results, SAVE_LLM_RESULT)
